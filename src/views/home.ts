  ...
  <section class="categories" id="colecoes">
    ...
    <div class="categories-grid">
      <a href="/categoria/shorts" class="category-card">
        <img src="${shorts.length > 0 && shorts[0] ? getImagePath(shorts[0]) : '/assets/imgs/placeholder.jpg'}" alt="Shorts">
      ...
      <a href="/categoria/conjuntos" class="category-card">
        <img src="${conjuntos.length > 0 && conjuntos[0] ? getImagePath(conjuntos[0]) : '/assets/imgs/placeholder.jpg'}" alt="Conjuntos">
        <div class="category-overlay">
          <div class="category-info">
            <h3>Conjuntos</h3>
            <span>Ver Coleção</span>
      ...
      <a href="/categoria/macacoes" class="category-card">
        <img src="${macacoes.length > 0 && macacoes[0] ? getImagePath(macacoes[0]) : '/assets/imgs/placeholder.jpg'}" alt="Macacões">
        <div class="category-overlay">
          <div class="category-info">
            <h3>Macacões</h3>
            <span>Ver Coleção</span>
      ...
      <a href="/categoria/bodys" class="category-card">
        <img src="${bodys.length > 0 && bodys[0] ? getImagePath(bodys[0]) : '/assets/imgs/placeholder.jpg'}" alt="Bodys">
        <div class="category-overlay">
          <div class="category-info">
            <h3>Bodys</h3>
            <span>Ver Coleção</span>
